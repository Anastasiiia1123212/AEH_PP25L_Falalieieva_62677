...
public class  mojaPiataAplikacja {
    ...
    private static int calculateScore_argumentsReturn(boolean gameOver, int score, int levelCompleted, int bonus) {
        ...
        return finalScore; */
            printSymbolMultipleTimes('*', 10, 7); // 10 gw  w 7
        printSymbolMultipleTimes('#', 4, 3);  // 4 krz w 3
        printSymbolMultipleTimes('@', 6, 4);  // 6 @ w 4
    }
                public static void      printSymbolMultipleTimes(char symbol, int width, int height) {
